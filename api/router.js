...
const TransaccionControlador = require('../app/controladores/transaccionControlador');//IMmportamos la clase controlador
...
app.get('/transacciones/:_tk', function(req, res){
